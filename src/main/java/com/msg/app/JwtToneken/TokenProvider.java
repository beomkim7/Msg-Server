...
public class TokenProvider implements InitializingBean {
    ...
    //빈 생성하고 주입받은후 secret 값을 base64 Decode 해서 key 변수에 할당하기위함
    @Override
    ...
    public String createToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .signWith(key, SignatureAlgorithm.HS512) //사용할 암호화 알고리즘 , signature에 들어갈 secret값 세팅
                .setExpiration(expiration) //set Expire Time 해당 옵션 안넣으면 expire안함
                .compact();
    }


    //토큰으로 클레임을 만들고 이를 이용해 유저객체를 만들어서 최종적으로 authentication 객체를 리턴
